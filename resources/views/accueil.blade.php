...
@section('content')
    ...
    <section id="accueil" class="hero-section">
        <div class="hero-slider">
            <div class="hero-slide active"
                style="background-image: url('https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80')">
                <div class="container">
            ...
            <div class="hero-slide"
                style="background-image: url('https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80')">
                <div class="container">
                    <div class="hero-content">
            ...
            <div class="hero-slide"
                style="background-image: url('https://images.unsplash.com/photo-1542810634-71277d95dcbb?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80')">
                <div class="container">
                    <div class="hero-content">
            ...
            <div class="welcome-wrapper">
                ...
                <div class="welcome-content" data-aos="fade-left">
                    ...
                    <div class="welcome-text">
                        <p>"C'est avec un profond sentiment d'espoir et une vision claire que je vous accueille sur
                            notre site. NÉHÉMIE International est née d'une conviction profonde : la foi authentique
                            s'exprime naturellement par des actes concrets d'amour et de service qui restaurent la
                            dignité humaine."</p>
                        <p>"À l'heure où le Gabon fait face à des défis sociaux considérables, nous sommes persuadés que
                            les valeurs de compassion, de service et d'intégrité peuvent constituer le socle d'un
                            développement durable et équitable."</p>
                        <p>"Je vous invite à découvrir notre mission et à vous joindre à nous dans cette œuvre de
                            reconstruction et d'espérance."</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="qui-sommes-nous" class="mission-section">
        <div class="container">
            <div class="section-heading text-center" data-aos="fade-up">
                <h2>Notre mission</h2>
                <div class="heading-line center"></div>
                <p class="section-subtitle">NÉHÉMIE International existe pour exprimer sa foi par son engagement en
            ...
            <div class="mission-approach" data-aos="fade-up">
                ...
                <div class="mission-quote">
                    ...
                    <blockquote>
                        À quoi bon dire qu'on a la foi, si l'on n'a pas les œuvres ? La foi peut-elle sauver, si elle
                        n'a pas les œuvres ? Si un frère ou une sœur sont nus, s'ils manquent de leur nourriture
                        quotidienne, et que l'un d'entre vous leur dise : Allez en paix, chauffez-vous et rassasiez-vous
            ...
            <div class="text-center" data-aos="fade-up">
                <a href="#nos-programmes" class="btn btn-secondary">Découvrir nos programmes</a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="campaign-wrapper">
                <div class="campaign-image" data-aos="fade-right">
                    <img src="https://nehemie-international.com/wp-content/uploads/2024/05/CAMPAGNE-DLVAM-JUIN-2024-1024x576.jpg"
                        alt="Campagne Donnez-leur vous-mêmes à manger">
                </div>
        ...
        <div class="container">
            ...
            <div class="programs-tabs" data-aos="fade-up">
                <div class="programs-tabs-nav">
                    <button class="program-tab active" data-program="timothee">
                        <i class="fas fa-graduation-cap"></i>
                        <span>TIMOTHÉE</span>
                    </button>
                    <button class="program-tab" data-program="philippe">
                        <i class="fas fa-bullhorn"></i>
                        <span>PHILIPPE</span>
                    </button>
                    <button class="program-tab" data-program="dorcas">
                        <i class="fas fa-hand-holding-heart"></i>
                        <span>DORCAS</span>
                    </button>
                    <button class="program-tab" data-program="bethanie">
                ...
                <div class="programs-tabs-content">
                    <div class="program-content active" id="program-timothee">
                        <div class="program-content-inner">
                            <div class="program-image">
                                <img src="https://images.unsplash.com/photo-1522661067900-ab829854a57f?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
                                    alt="Programme TIMOTHÉE">
                            </div>
                            <div class="program-details">
                                <h3>Programme TIMOTHÉE</h3>
                                <p class="program-tagline">Formation et développement des compétences</p>
                                <p>Le programme TIMOTHÉE vise à équiper les jeunes et les adultes avec des compétences
                                    pratiques et des connaissances qui favorisent leur autonomie économique et leur
                                    développement personnel.</p>
                                <h4>Nos actions :</h4>
                                <ul class="program-actions">
                                    <li><i class="fas fa-check"></i> Formations professionnelles (bureautique, langues,
                                        entrepreneuriat)</li>
                                    <li><i class="fas fa-check"></i> Accompagnement à l'insertion professionnelle</li>
                                    <li><i class="fas fa-check"></i> Mentorat et coaching personnalisé</li>
                                    <li><i class="fas fa-check"></i> Ateliers de développement personnel</li>
                                </ul>
                    ...
                    <div class="program-content" id="program-philippe">
                        <div class="program-content-inner">
                            <div class="program-image">
                                <img src="https://images.unsplash.com/photo-1531545514256-b1400bc00f31?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
                                    alt="Programme PHILIPPE">
                            </div>
                            <div class="program-details">
                                <h3>Programme PHILIPPE</h3>
                                <p class="program-tagline">Sensibilisation et partage de valeurs</p>
                                <p>Le programme PHILIPPE se consacre à la sensibilisation et au partage des valeurs
                                    chrétiennes à travers des actions concrètes qui témoignent de notre foi par les
                                    actes.</p>
                                <h4>Nos actions :</h4>
                                <ul class="program-actions">
                                    <li><i class="fas fa-check"></i> Campagnes de sensibilisation communautaire</li>
                    ...
                    <div class="program-content" id="program-dorcas">
                        <div class="program-content-inner">
                            <div class="program-image">
                            ...
                            <div class="program-details">
                                ...
                                <p>Le programme DORCAS répond aux besoins essentiels des populations vulnérables à
                                    travers des actions humanitaires et sociales qui témoignent de notre compassion en
                                    actes.</p>
                                <h4>Nos actions :</h4>
                                <ul class="program-actions">
                                    <li><i class="fas fa-check"></i> Distribution de denrées alimentaires</li>
                                    <li><i class="fas fa-check"></i> Fourniture de produits d'hygiène et de première
                                        nécessité</li>
                                    <li><i class="fas fa-check"></i> Soutien aux familles en situation précaire</li>
                    ...
                    <div class="program-content" id="program-bethanie">
                        <div class="program-content-inner">
                            <div class="program-image">
                            ...
                            <div class="program-details">
                                ...
                                <p>Le programme BÉTHANIE crée des espaces de communion fraternelle et de soutien mutuel,
                                    favorisant les liens communautaires et l'entraide entre les personnes.</p>
                                <h4>Nos actions :</h4>
                                <ul class="program-actions">
                                    <li><i class="fas fa-check"></i> Organisation de rencontres communautaires</li>
                    ...
                    <div class="program-content" id="program-daniel">
                        <div class="program-content-inner">
                            ...
                            <div class="program-details">
                                ...
                                <p>Le programme DANIEL offre un accompagnement spirituel et un soutien pastoral aux
                                ...
                                <ul class="program-actions">
                                    ...
                                    <li><i class="fas fa-check"></i> Ressources pour la croissance spirituelle</li>
                                </ul>
                                <a href="#" class="btn btn-secondary">En savoir plus</a>
                            </div>
                        </div>
    ...
    <section id="temoignages" class="testimonials-section">
        <div class="container">
            <div class="section-heading text-center" data-aos="fade-up">
                <h2>Témoignages</h2>
                <div class="heading-line center"></div>
                <p class="section-subtitle">Ce que nos bénéficiaires et partenaires disent de nous</p>
            </div>
            ...
            <div class="testimonials-slider" data-aos="fade-up">
                <div class="testimonials-wrapper">
                    <div class="testimonial active">
                        <div class="testimonial-content">
                            ...
                            <p>Grâce à la formation en entrepreneuriat de NÉHÉMIE, j'ai pu lancer ma petite entreprise
                                et subvenir aux besoins de ma famille. C'est bien plus qu'une aide, c'est une
                                transformation complète de ma vie.</p>
                            <div class="testimonial-author">
                                <img src="https://via.placeholder.com/80/CBD5E0/FFFFFF?Text=MK" alt="Marie Koumba">
                    ...
                    <div class="testimonial">
                        <div class="testimonial-content">
                            ...
                            <p>L'accompagnement spirituel reçu au travers du programme DANIEL m'a redonné espoir et
                                force dans une période difficile. Je suis reconnaissant pour leur écoute et leurs
                                prières.</p>
                            <div class="testimonial-author">
                                <img src="https://via.placeholder.com/80/A3BFFA/FFFFFF?Text=PN" alt="Paul Ntoutoume">
                                <div class="author-info">
                    ...
                    <div class="testimonial">
                        <div class="testimonial-content">
                            ...
                            <p>En tant que partenaire, nous sommes impressionnés par le dévouement et la transparence de
                                NÉHÉMIE International. Leur impact sur la communauté est tangible.</p>
                            <div class="testimonial-author">
                                <img src="https://via.placeholder.com/80/FBBF24/FFFFFF?Text=DI" alt="M. Diallo Ibrahim">
                                <div class="author-info">
                ...
                <div class="testimonials-controls">
                    <button class="testimonial-control prev" aria-label="Témoignage précédent"><i
                    ...
                    <button class="testimonial-control next" aria-label="Témoignage suivant"><i
            ...
            <div class="news-grid" data-aos="fade-up">
                <div class="news-card">
                    <div class="news-image">
                        <img src="https://nehemie-international.com/wp-content/uploads/2024/05/Formation-Club-Anglais-Mai-2024-768x432.jpg"
                            alt="Lancement du Club d'Anglais">
                        <div class="news-date">
                ...
                <div class="news-card">
                    <div class="news-image">
                        <img src="https://nehemie-international.com/wp-content/uploads/2024/04/Distribution-DORCAS-Avril-2024-768x432.jpg"
                    ...
                    <div class="news-content">
                        ...
                        <p>Dans le cadre du programme DORCAS, une importante distribution de vivres a eu lieu dans le
                            quartier Akébé...</p>
                        <a href="#" class="news-link">Lire la suite <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
                ...
                <div class="news-card">
                    <div class="news-image">
                        <img src="https://nehemie-international.com/wp-content/uploads/2024/02/Visite-terrain-Nzeng-Ayong-768x432.jpeg"
                    ...
                    <div class="news-content">
                        ...
                        <p>L'équipe de NÉHÉMIE s'est rendue à Nzeng-Ayong pour une évaluation des besoins des familles
                            vulnérables...</p>
                        <a href="#" class="news-link">Lire la suite <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
    ...
    <section id="faire-un-don" class="donation-section">
        <div class="container">
            <div class="section-heading text-center" data-aos="fade-up">
                <h2>S'impliquer & Faire un Don</h2>
                <div class="heading-line center"></div>
            ...
            <div class="donation-wrapper" data-aos="fade-up">
                <div class="donation-options">
                    <h3>Faire un Don</h3>
                    <p>Chaque contribution, petite ou grande, fait une différence significative dans la vie des
                        personnes que nous servons. Voici comment vous pouvez donner :</p>
                    ...
                    <div class="donation-method">
                        ...
                        <div class="method-details">
                            ...
                            <p><strong>Banque :</strong> BGFI Bank Gabon<br>
                                <strong>Titulaire :</strong> ONG NEHEMIE INTERNATIONAL<br>
                                <strong>N° Compte :</strong> XXXXXXXXXXXX<br>
                                <strong>Code SWIFT/BIC :</strong> BGFXXXXX
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="donation-method">
                        ...
                        <div class="method-details">
                            <h4>Mobile Money</h4>
                            <p><strong>Airtel Money :</strong> +241 XX XX XX XX<br>
                    ...
                    <div class="donation-method">
                        ...
                        <div class="method-details">
                            ...
                            <p>Faites un don sécurisé en ligne via notre plateforme de paiement.</p>
                            <a href="#" class="btn btn-primary">Donner maintenant</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="volunteer-options">
                    ...
                    <p>Vous souhaitez vous engager à nos côtés ? Nous avons besoin de bénévoles dans différents domaines
                        :</p>
    ...
    <section id="contact" class="contact-section">
        <div class="container">
            <div class="section-heading text-center" data-aos="fade-up">
                ...
                <div class="heading-line center"></div>
                <p class="section-subtitle">Nous sommes à votre écoute pour toute question ou proposition</p>
            </div>
                ...
                <div class="contact-info">
                    <div class="contact-item">
                        ...
                        <div class="contact-text">
                            <h4>Adresse</h4>
                            <p>Quartier Nzeng-Ayong<br>Libreville, Gabon</p>
                        </div>
                    </div>
                    ...
                    <div class="contact-item">
                        ...
                        <div class="contact-text">
                            <h4>Email</h4>
                            <p>contact@nehemie-international.com</p>
                        </div>
                    </div>
                ...
                <div class="contact-form">
                    <form id="contactForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="contactSubject" placeholder="Sujet de votre message" required>
                        </div>
                        <div class="form-group">
    ...
    <section class="map-section">
        <div class="map-container">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d127504.42550263697!2d9.395304899999999!3d0.3927889!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x107f3b8a5e8c7f2d%3A0xb9a8e4b25b9fee0c!2sLibreville%2C%20Gabon!5e0!3m2!1sfr!2sfr!4v1621345678901!5m2!1sfr!2sfr"
