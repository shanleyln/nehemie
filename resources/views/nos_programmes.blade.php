                                ...
                                <section id="programme-salomon" class="mb-16 bg-white rounded-xl  overflow-hidden">
                                    ...
                                    <div class="p-6 sm:p-8">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                                            <div>
                                                <h4 class="text-xl font-semibold mb-3 text-blue-700">Objectifs Généraux
                                                </h4>
                                        ...
                                        <h4 class="text-xl font-semibold mb-4 text-blue-700">Projets Potentiels à
                                            Développer</h4>
                            ...
                            <div class="program-content" id="program-joseph">
                                ...
                                <section id="programme-joseph" class="mb-16 bg-white rounded-xl  overflow-hidden">
                                    ...
                                    <div class="p-6 sm:p-8">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                                            <div>
                                                <h4 class="text-xl font-semibold mb-3 text-green-700">Objectifs Généraux
                                                </h4>
                                                <ul class="list-disc list-inside pl-2 space-y-2 text-gray-700">
                                        ...
                                        <h4 class="text-xl font-semibold mb-4 text-green-700">Projets Potentiels à
                                            Développer</h4>
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                            <div
                                                class="bg-gray-50 p-5 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                                                <h5 class="font-bold text-lg text-green-600 mb-1">Incubateur d'Entreprises
                                                    Joseph</h5>
                                            ...
                                            <div
                                                class="bg-gray-50 p-5 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                                                <h5 class="font-bold text-lg text-green-600 mb-1">Fonds d'Investissement
                                                    Éthique</h5>
                                            ...
                                            <div
                                                class="bg-gray-50 p-5 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                                                <h5 class="font-bold text-lg text-green-600 mb-1">Réseau d'Affaires
                                            ...
                                            <div
                                                class="bg-gray-50 p-5 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                                                <h5 class="font-bold text-lg text-green-600 mb-1">Programme de Formation en
                                                    Gestion Intègre
                                                </h5>
                            ...
                            <div class="program-content" id="program-david">
                                ...
                                <section id="programme-david" class="mb-16 bg-white rounded-xl  overflow-hidden">
                                    <div class="bg-yellow-500 text-white p-8"> <!-- Changed to amber/yellow -->
                                        <h2 class="text-3xl font-bold flex items-center text-white">
                                            <i class="fas fa-guitar fa-fw mr-4 text-yellow-200 text-4xl"></i>
                                            <!-- Updated icon and color -->
                                            Programme DAVID
                                        </h2>
                                        <p class="text-yellow-100 text-lg mt-1">Arts/Divertissement + Médias/Communications
                                        </p>
                                    </div>
                                    <div class="p-6 sm:p-8">
                                        ...
                                        <div
                                            class="bg-yellow-50 p-5 rounded-lg border-l-4 border-yellow-400 mb-6 shadow-sm">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                                            <div>
                                                <h4 class="text-xl font-semibold mb-3 text-yellow-700">Objectifs Généraux
                                                </h4>
                                                <ul class="list-disc list-inside pl-2 space-y-2 text-gray-700">
                                        ...
                                        <h4 class="text-xl font-semibold mb-4 text-yellow-700">Projets Potentiels à
                                            Développer</h4>
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                            <div
                                                class="bg-gray-50 p-5 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                                                <h5 class="font-bold text-lg text-yellow-600 mb-1">Studio de Création
                                                    Davidique</h5>
                                            ...
                                            <div
                                                class="bg-gray-50 p-5 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                                                <h5 class="font-bold text-lg text-yellow-600 mb-1">Plateforme Média "Echo
                                                    du Royaume"</h5>
                                            ...
                                            <div
                                                class="bg-gray-50 p-5 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                                                <h5 class="font-bold text-lg text-yellow-600 mb-1">Ateliers "Art et Sens"
                                                </h5>
                                            ...
                                            <div
                                                class="bg-gray-50 p-5 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                                                <h5 class="font-bold text-lg text-yellow-600 mb-1">Festival Culturel
                                                    "Harmonie Divine"</h5>
                            ...
                            <div class="program-content" id="program-daniel">
                                ...
                                <section id="programme-daniel" class="mb-16 bg-white rounded-xl  overflow-hidden">
                                    <div class="bg-purple-600 text-white p-8"> <!-- Changed to violet/purple -->
                                        <h2 class="text-3xl font-bold flex items-center text-white">
                                            <i class="fas fa-scroll fa-fw mr-4 text-purple-200 text-4xl"></i>
                                            <!-- Updated icon and color -->
                                            Programme DANIEL
                                        </h2>
                                        <p class="text-purple-100 text-lg mt-1">Religion/Spiritualité + Gouvernement
                                            (secondaire)</p>
                                    </div>
                                    <div class="p-6 sm:p-8">
                                        ...
                                        <div
                                            class="bg-purple-50 p-5 rounded-lg border-l-4 border-purple-400 mb-6 shadow-sm">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                                            <div>
                                                <h4 class="text-xl font-semibold mb-3 text-purple-700">Objectifs Généraux
                                                </h4>
                                                <ul class="list-disc list-inside pl-2 space-y-2 text-gray-700">
                                        ...
                                        <h4 class="text-xl font-semibold mb-4 text-purple-700">Projets Potentiels à
                                            Développer</h4>
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                            <div
                                                class="bg-gray-50 p-5 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                                                <h5 class="font-bold text-lg text-purple-600 mb-1">Institut Daniel de
                                            ...
                                            <div
                                                class="bg-gray-50 p-5 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                                                <h5 class="font-bold text-lg text-purple-600 mb-1">Plateforme "Foi &
                                                    Société"</h5>
                                            ...
                                            <div
                                                class="bg-gray-50 p-5 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                                                <h5 class="font-bold text-lg text-purple-600 mb-1">Programme de Mentorat
                                                    Spirituel</h5>
                                            ...
                                            <div
                                                class="bg-gray-50 p-5 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                                                <h5 class="font-bold text-lg text-purple-600 mb-1">Conférences "Éthique et
                                                    Foi"</h5>
                            ...
                            <div class="program-content" id="program-priscille">
                                ...
                                <section id="programme-priscille" class="mb-16 bg-white rounded-xl  overflow-hidden">
                                    <div class="bg-burgundy-600 text-white p-8">
                                        ...
                                        <p class="text-burgundy-100 text-lg mt-1">Famille + Action Sociale Communautaire +
                                            Éducation
                                            (secondaire)</p>
                                    </div>
                                    <div class="p-6 sm:p-8">
                                        ...
                                        <p class="mb-6 text-gray-700">
                                            ...
                                            environnante par l'hospitalité, le mentorat <strong
                                                class="text-burgundy-800">et des actions
