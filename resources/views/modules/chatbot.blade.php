    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const chatMessagesContainer = document.querySelector(
                '#chat-messages .messages'); // Le conteneur interne
        ...
        `;
                ...
                async function sendWithRetry() {
                    try {
                        ...
                        if (!res.ok) {
                            console.error(`5. Réponse du serveur non valide (${res.status}):`, res
                                .statusText);
                            ...
                            if (attempt < maxAttempts) {
                                ...
                                console.error('8. Dernière tentative échouée. Réponse complète:',
                                    errorText);
